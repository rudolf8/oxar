...
# AUTO Installer for APEX 19.1 and ORDS 19.2 :tropical_drink:
...
APEX             | 19.1                    | Currently supports APEX 19.X, 18.x, 5.x and APEX 4.x releases. Just reference the appropriate file in `config.properties`
ORDS             | 19.2                  |
Tomcat           | 7.0.57                  |
Node JS          | 8.x                     |
